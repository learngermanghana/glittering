    ...
    <Container>
      <section className="py-12 sm:py-16">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <SectionTitle
            title="Products"
            subtitle="Shop our glow essentials and best-sellers. Inventory is synced from Firebase with automatic fallback support."
          />
          <a
        ...
        {products.length ? (
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {products.map((product) => (
              <div key={product.id ?? product.name} className="rounded-3xl border border-black/10 bg-white p-4 shadow-sm">
          ...
          <div className="mt-8 rounded-3xl border border-dashed border-neutral-300 bg-white p-8 text-center text-sm text-neutral-600">
