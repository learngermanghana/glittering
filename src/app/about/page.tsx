    ...
    <Container>
      <section className="py-12 sm:py-16">
        <SectionTitle
          ...
          subtitle="A calm, clean, welcoming space for your self-care — and the story behind it."
        />
        ...
        <div className="grid gap-6 rounded-3xl border border-black/10 bg-white p-6 shadow-sm lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            <p className="text-neutral-700 leading-7">
              ...
              branch has now grown into two vibrant locations across Awoshie and Spintex, built on trust, quality
            ...
            <p className="mt-4 text-neutral-700 leading-7">
              ...
              artistry. Our mission is simple: create a public space where everyone can discover a confident glow
              and leave feeling refreshed, cared for, and celebrated.
            </p>
          </div>
